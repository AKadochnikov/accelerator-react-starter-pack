...
function CatalogFilter (): JSX.Element {
  ...
  return (
    <form className="catalog-filter">
      ...
      <FilterPrice/>
      <FilterType newGuitarCounts={newGuitarCounts} newGuitarTypes={newGuitarTypes} onChangeTypes={setNewGuitarTypes} onChangeCounts={setNewGuitarCounts}/>
      <FilterStringsCount newGuitarCounts={newGuitarCounts} newGuitarTypes={newGuitarTypes} onChangeCounts={setNewGuitarCounts} onChangeTypes={setNewGuitarTypes}/>
    </form>
  );
}
